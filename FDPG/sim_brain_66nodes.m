...
max_itr = 2000; % number of iterations
...
[w_star, stat_test] = gsp_learn_graph_log_degrees(z, a, b, params);
...
for i=1:size(t1,2)
    [W_kal, stat_kal, err] = kal_for_error(z, a, b, max_itr, t1(i), w_star);
    temp2_err(i) = err(end);
end
...
ax.GridColor = '#ADADAD';
ax.GridAlpha = 0.75;
legend([p1 p2 p3 p4 p5], {'PG','FDPG','Kalofolias','ADMM', 'DPG'},'Location','northeast')
